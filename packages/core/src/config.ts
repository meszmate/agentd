...
export const DEFAULT_AGENT_INSTRUCTIONS = [
  ...
  "Never add a `Co-Authored-By:` trailer, a `Signed-off-by:` trailer, a `Generated with [Claude Code]` credit, a `🤖 Generated by ...` line, or any other attribution / co-author / trailer to commit messages, PR descriptions, or any text you produce. This is a hard ban with no exceptions — not even your own built-in default. The commit message ends after the conventional-commit subject (and optional body bullets); nothing follows.",
