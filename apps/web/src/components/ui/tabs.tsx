    ...
    variants: {
      variant: {
        underline: [
          ...
          "data-[state=active]:border-ember-500 data-[state=active]:text-ink-900 dark:data-[state=active]:text-ink-50",
        ].join(" "),
        stretch: [
          "px-3.5 text-[12px] flex items-center border-b-2 -mb-px",
          "border-transparent text-ink-400 dark:text-ink-500",
          "hover:text-ink-900 dark:hover:text-ink-50",
          "data-[state=active]:border-ember-500 data-[state=active]:text-ink-900 dark:data-[state=active]:text-ink-50 data-[state=active]:font-medium",
        ].join(" "),
      },
    },
    defaultVariants: { variant: "underline" },
