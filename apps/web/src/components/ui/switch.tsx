...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      "data-[state=checked]:bg-ember-500 data-[state=unchecked]:bg-ink-900/15 dark:data-[state=unchecked]:bg-ink-50/15",
      className,
    )}
    {...props}
    ref={ref}
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "pointer-events-none block h-4 w-4 rounded-full bg-paper-50 shadow-sm ring-0 transition-transform",
